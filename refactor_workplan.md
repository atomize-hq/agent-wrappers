...
1) P1.8 — Plan next Phase 1 seams after `builder/*` (no code moves)
2) (TBD) Next Phase 2 follow-on after P2.7
3) (TBD) Next Phase 3 follow-on after P3.9
4) (TBD) Next cross-phase follow-on
5) (TBD) Next follow-on
