...
1) P3.9 — Reduce `codex_validate.rs` below ceiling (follow-on split) with deterministic output preserved
2) (TBD) Next Phase 1 seam extraction after P1.6
3) (TBD) Next Phase 2 follow-on after P2.7
4) (TBD) Next Phase 3 follow-on after P3.9
5) (TBD) Next cross-phase follow-on
