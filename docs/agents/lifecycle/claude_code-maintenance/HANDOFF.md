...
- target_version: `2.1.227`
- latest_stable: `2.1.227`
...
- branch_name: `automation/claude_code-maintenance-2.1.227`
...
- prompt sha256: `93a5c999d17d9378aa5dd616759a5013475064c712a325873bb87bf7900a90c2`
...
- branch linkage: `automation/claude_code-maintenance-2.1.227`
...
- `cli_manifests/claude_code/snapshots/2.1.227/**`
- `cli_manifests/claude_code/reports/2.1.227/**`
- `cli_manifests/claude_code/versions/2.1.227.json`
...
- reopen pr branch: `automation/claude_code-maintenance-2.1.227`
- notes:
...
```md
# Packet PR Maintenance Prompt (`2.1.227`)
...
Execute the automated maintenance packet for `claude_code` target `2.1.227`.
...
1. Compare the current validated baseline from `cli_manifests/claude_code/latest_validated.txt` against the target `2.1.227` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/claude_code/snapshots/2.1.227/`, `cli_manifests/claude_code/reports/2.1.227/`, and `cli_manifests/claude_code/versions/2.1.227.json` as required by the packet.
