...
- prompt sha256: `5f25a4e8ce9f3854f9f205c4213549a1e5792dd43c4bf715606c180cc65d5e21`
...
- branch linkage: `automation/claude_code-maintenance-2.1.206`
...
- `cli_manifests/claude_code/snapshots/2.1.206/**`
- `cli_manifests/claude_code/reports/2.1.206/**`
- `cli_manifests/claude_code/versions/2.1.206.json`
...
- reopen pr branch: `automation/claude_code-maintenance-2.1.206`
- notes:
...
```md
# Packet PR Maintenance Prompt (`2.1.206`)
...
Execute the automated maintenance packet for `claude_code` target `2.1.206`.
...
1. Compare the current validated baseline from `cli_manifests/claude_code/latest_validated.txt` against the target `2.1.206` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/claude_code/snapshots/2.1.206/`, `cli_manifests/claude_code/reports/2.1.206/`, and `cli_manifests/claude_code/versions/2.1.206.json` as required by the packet.
