...
- target_version: `2.1.228`
- latest_stable: `2.1.228`
...
- branch_name: `automation/claude_code-maintenance-2.1.228`
...
- prompt sha256: `94256edd83b40ee1b15ef8f540e294262c0d2ec21201283d086454be225156e3`
...
- branch linkage: `automation/claude_code-maintenance-2.1.228`
...
- `cli_manifests/claude_code/snapshots/2.1.228/**`
- `cli_manifests/claude_code/reports/2.1.228/**`
- `cli_manifests/claude_code/versions/2.1.228.json`
...
- reopen pr branch: `automation/claude_code-maintenance-2.1.228`
- notes:
...
```md
# Packet PR Maintenance Prompt (`2.1.228`)
...
Execute the automated maintenance packet for `claude_code` target `2.1.228`.
...
1. Compare the current validated baseline from `cli_manifests/claude_code/latest_validated.txt` against the target `2.1.228` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/claude_code/snapshots/2.1.228/`, `cli_manifests/claude_code/reports/2.1.228/`, and `cli_manifests/claude_code/versions/2.1.228.json` as required by the packet.
