...
- target_version: `2.1.221`
- latest_stable: `2.1.221`
...
- branch_name: `automation/claude_code-maintenance-2.1.221`
...
- prompt sha256: `4a164a5e7b6e257021fed51dc8da8ae2e0903c3add7a048605e00ce8320d2822`
...
- branch linkage: `automation/claude_code-maintenance-2.1.221`
...
- `cli_manifests/claude_code/snapshots/2.1.221/**`
- `cli_manifests/claude_code/reports/2.1.221/**`
- `cli_manifests/claude_code/versions/2.1.221.json`
...
- reopen pr branch: `automation/claude_code-maintenance-2.1.221`
- notes:
...
```md
# Packet PR Maintenance Prompt (`2.1.221`)
...
Execute the automated maintenance packet for `claude_code` target `2.1.221`.
...
1. Compare the current validated baseline from `cli_manifests/claude_code/latest_validated.txt` against the target `2.1.221` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/claude_code/snapshots/2.1.221/`, `cli_manifests/claude_code/reports/2.1.221/`, and `cli_manifests/claude_code/versions/2.1.221.json` as required by the packet.
