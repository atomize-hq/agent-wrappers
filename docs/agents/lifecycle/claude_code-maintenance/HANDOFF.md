...
- branch_name: `automation/claude_code-maintenance-2.1.226`
...
- prompt sha256: `94234071c0834a49e7b8258e8395dbb133aa3cca1916b2e06a015574d43a90cd`
...
- branch linkage: `automation/claude_code-maintenance-2.1.226`
...
- `cli_manifests/claude_code/snapshots/2.1.226/**`
- `cli_manifests/claude_code/reports/2.1.226/**`
- `cli_manifests/claude_code/versions/2.1.226.json`
...
- reopen pr branch: `automation/claude_code-maintenance-2.1.226`
- notes:
...
```md
# Packet PR Maintenance Prompt (`2.1.226`)
...
Execute the automated maintenance packet for `claude_code` target `2.1.226`.
...
1. Compare the current validated baseline from `cli_manifests/claude_code/latest_validated.txt` against the target `2.1.226` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/claude_code/snapshots/2.1.226/`, `cli_manifests/claude_code/reports/2.1.226/`, and `cli_manifests/claude_code/versions/2.1.226.json` as required by the packet.
