...
- branch_name: `automation/claude_code-maintenance-2.1.220`
...
- prompt sha256: `9be90674042ec8f5bf7b81e732cdab612c03590a55240552038ab8fc80fd3f88`
...
- branch linkage: `automation/claude_code-maintenance-2.1.220`
...
- `cli_manifests/claude_code/snapshots/2.1.220/**`
- `cli_manifests/claude_code/reports/2.1.220/**`
- `cli_manifests/claude_code/versions/2.1.220.json`
...
- reopen pr branch: `automation/claude_code-maintenance-2.1.220`
- notes:
...
```md
# Packet PR Maintenance Prompt (`2.1.220`)
...
Execute the automated maintenance packet for `claude_code` target `2.1.220`.
...
1. Compare the current validated baseline from `cli_manifests/claude_code/latest_validated.txt` against the target `2.1.220` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/claude_code/snapshots/2.1.220/`, `cli_manifests/claude_code/reports/2.1.220/`, and `cli_manifests/claude_code/versions/2.1.220.json` as required by the packet.
