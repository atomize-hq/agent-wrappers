...
- target_version: `2.1.231`
- latest_stable: `2.1.231`
...
- branch_name: `automation/claude_code-maintenance-2.1.231`
...
- prompt sha256: `43285d6fff33055432ca2d5c6bd60a513f6cb901f17bc21fb1fecd6c8899cd06`
...
- branch linkage: `automation/claude_code-maintenance-2.1.231`
...
- `cli_manifests/claude_code/snapshots/2.1.231/**`
- `cli_manifests/claude_code/reports/2.1.231/**`
- `cli_manifests/claude_code/versions/2.1.231.json`
...
- reopen pr branch: `automation/claude_code-maintenance-2.1.231`
- notes:
...
```md
# Packet PR Maintenance Prompt (`2.1.231`)
...
Execute the automated maintenance packet for `claude_code` target `2.1.231`.
...
1. Compare the current validated baseline from `cli_manifests/claude_code/latest_validated.txt` against the target `2.1.231` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/claude_code/snapshots/2.1.231/`, `cli_manifests/claude_code/reports/2.1.231/`, and `cli_manifests/claude_code/versions/2.1.231.json` as required by the packet.
