...
- target_version: `2.1.222`
- latest_stable: `2.1.222`
...
- branch_name: `automation/claude_code-maintenance-2.1.222`
...
- prompt sha256: `93818ef2dff5e4415eff047958496b1529d4938e687f2a12c497ebec6a63b4d1`
...
- branch linkage: `automation/claude_code-maintenance-2.1.222`
...
- `cli_manifests/claude_code/snapshots/2.1.222/**`
- `cli_manifests/claude_code/reports/2.1.222/**`
- `cli_manifests/claude_code/versions/2.1.222.json`
...
- reopen pr branch: `automation/claude_code-maintenance-2.1.222`
- notes:
...
```md
# Packet PR Maintenance Prompt (`2.1.222`)
...
Execute the automated maintenance packet for `claude_code` target `2.1.222`.
...
1. Compare the current validated baseline from `cli_manifests/claude_code/latest_validated.txt` against the target `2.1.222` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/claude_code/snapshots/2.1.222/`, `cli_manifests/claude_code/reports/2.1.222/`, and `cli_manifests/claude_code/versions/2.1.222.json` as required by the packet.
