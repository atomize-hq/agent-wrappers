...
- branch_name: `automation/claude_code-maintenance-2.1.212`
...
- prompt sha256: `649527918e7da85373d6e734cf5eef1914e208ea980921d0b5c6d39b7956bd6c`
...
- branch linkage: `automation/claude_code-maintenance-2.1.212`
...
- `cli_manifests/claude_code/snapshots/2.1.212/**`
- `cli_manifests/claude_code/reports/2.1.212/**`
- `cli_manifests/claude_code/versions/2.1.212.json`
...
- reopen pr branch: `automation/claude_code-maintenance-2.1.212`
- notes:
...
```md
# Packet PR Maintenance Prompt (`2.1.212`)
...
Execute the automated maintenance packet for `claude_code` target `2.1.212`.
...
1. Compare the current validated baseline from `cli_manifests/claude_code/latest_validated.txt` against the target `2.1.212` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/claude_code/snapshots/2.1.212/`, `cli_manifests/claude_code/reports/2.1.212/`, and `cli_manifests/claude_code/versions/2.1.212.json` as required by the packet.
