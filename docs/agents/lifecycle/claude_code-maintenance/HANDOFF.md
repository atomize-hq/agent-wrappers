...
- target_version: `2.1.223`
- latest_stable: `2.1.223`
...
- branch_name: `automation/claude_code-maintenance-2.1.223`
...
- prompt sha256: `aa8338402de6d62ceb072d3067f83a3a7d2a1eede825c8690b3d17eec7253a82`
...
- branch linkage: `automation/claude_code-maintenance-2.1.223`
...
- `cli_manifests/claude_code/snapshots/2.1.223/**`
- `cli_manifests/claude_code/reports/2.1.223/**`
- `cli_manifests/claude_code/versions/2.1.223.json`
...
- reopen pr branch: `automation/claude_code-maintenance-2.1.223`
- notes:
...
```md
# Packet PR Maintenance Prompt (`2.1.223`)
...
Execute the automated maintenance packet for `claude_code` target `2.1.223`.
...
1. Compare the current validated baseline from `cli_manifests/claude_code/latest_validated.txt` against the target `2.1.223` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/claude_code/snapshots/2.1.223/`, `cli_manifests/claude_code/reports/2.1.223/`, and `cli_manifests/claude_code/versions/2.1.223.json` as required by the packet.
