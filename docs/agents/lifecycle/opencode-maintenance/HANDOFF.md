...
- target_version: `1.18.22`
- latest_stable: `1.18.23`
- version_policy: `latest_stable_minus_one`
- source_kind: `github_releases`
- source_ref: `anomalyco/opencode`
- dispatch_kind: `packet_pr`
- dispatch_workflow: `agent-maintenance-open-pr.yml`
- branch_name: `automation/opencode-maintenance-1.18.22`
...
- prompt sha256: `2073adc12974e5d84a402dc3a18acf71982c29a65a59675198d76f8891e53d41`
...
- branch linkage: `automation/opencode-maintenance-1.18.22`
...
- `cli_manifests/opencode/snapshots/1.18.22/**`
- `cli_manifests/opencode/reports/1.18.22/**`
- `cli_manifests/opencode/versions/1.18.22.json`
...
- reopen pr branch: `automation/opencode-maintenance-1.18.22`
- notes:
...
```md
# Packet PR Maintenance Prompt (`1.18.22`)
...
Execute the automated maintenance packet for `opencode` target `1.18.22`.
...
1. Compare the current validated baseline from `cli_manifests/opencode/latest_validated.txt` against the target `1.18.22` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/opencode/snapshots/1.18.22/`, `cli_manifests/opencode/reports/1.18.22/`, and `cli_manifests/opencode/versions/1.18.22.json` as required by the packet.
