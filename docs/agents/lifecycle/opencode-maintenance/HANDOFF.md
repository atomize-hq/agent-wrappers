...
- prompt sha256: `3df555fb205189a7fb2cd35ade928a581d4276b439c183e41ece5174a5bfabef`
...
- branch linkage: `automation/opencode-maintenance-1.18.18`
...
- `cli_manifests/opencode/snapshots/1.18.18/**`
- `cli_manifests/opencode/reports/1.18.18/**`
- `cli_manifests/opencode/versions/1.18.18.json`
...
- reopen pr branch: `automation/opencode-maintenance-1.18.18`
- notes:
...
```md
# Packet PR Maintenance Prompt (`1.18.18`)
...
Execute the automated maintenance packet for `opencode` target `1.18.18`.
...
1. Compare the current validated baseline from `cli_manifests/opencode/latest_validated.txt` against the target `1.18.18` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/opencode/snapshots/1.18.18/`, `cli_manifests/opencode/reports/1.18.18/`, and `cli_manifests/opencode/versions/1.18.18.json` as required by the packet.
