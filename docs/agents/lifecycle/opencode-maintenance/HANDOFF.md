...
- target_version: `1.18.9`
- latest_stable: `1.18.10`
- version_policy: `latest_stable_minus_one`
- source_kind: `github_releases`
- source_ref: `anomalyco/opencode`
- dispatch_kind: `packet_pr`
- dispatch_workflow: `agent-maintenance-open-pr.yml`
- branch_name: `automation/opencode-maintenance-1.18.9`
...
- prompt sha256: `1b9b0624e88a3bc2b072c958814f906912b1eae51436840497bbd9df1e02efca`
...
- branch linkage: `automation/opencode-maintenance-1.18.9`
...
- `cli_manifests/opencode/snapshots/1.18.9/**`
- `cli_manifests/opencode/reports/1.18.9/**`
- `cli_manifests/opencode/versions/1.18.9.json`
...
- reopen pr branch: `automation/opencode-maintenance-1.18.9`
- notes:
...
```md
# Packet PR Maintenance Prompt (`1.18.9`)
...
Execute the automated maintenance packet for `opencode` target `1.18.9`.
...
1. Compare the current validated baseline from `cli_manifests/opencode/latest_validated.txt` against the target `1.18.9` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/opencode/snapshots/1.18.9/`, `cli_manifests/opencode/reports/1.18.9/`, and `cli_manifests/opencode/versions/1.18.9.json` as required by the packet.
