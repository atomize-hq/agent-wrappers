...
- target_version: `1.18.24`
- latest_stable: `1.18.25`
- version_policy: `latest_stable_minus_one`
- source_kind: `github_releases`
- source_ref: `anomalyco/opencode`
- dispatch_kind: `packet_pr`
- dispatch_workflow: `agent-maintenance-open-pr.yml`
- branch_name: `automation/opencode-maintenance-1.18.24`
...
- prompt sha256: `de97a718b9de08ee3fc74254ef030cb998f5a16ae3fd505dc36f4bca56009411`
...
- branch linkage: `automation/opencode-maintenance-1.18.24`
...
- `cli_manifests/opencode/snapshots/1.18.24/**`
- `cli_manifests/opencode/reports/1.18.24/**`
- `cli_manifests/opencode/versions/1.18.24.json`
...
- reopen pr branch: `automation/opencode-maintenance-1.18.24`
- notes:
...
```md
# Packet PR Maintenance Prompt (`1.18.24`)
...
Execute the automated maintenance packet for `opencode` target `1.18.24`.
...
1. Compare the current validated baseline from `cli_manifests/opencode/latest_validated.txt` against the target `1.18.24` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/opencode/snapshots/1.18.24/`, `cli_manifests/opencode/reports/1.18.24/`, and `cli_manifests/opencode/versions/1.18.24.json` as required by the packet.
