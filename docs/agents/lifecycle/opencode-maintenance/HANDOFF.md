...
- prompt sha256: `33b300442bd8bcdb7a62054a0fc3ebd48e17370d15fcc52658ed9dcb22e48f20`
...
- branch linkage: `automation/opencode-maintenance-1.18.4`
...
- `cli_manifests/opencode/snapshots/1.18.4/**`
- `cli_manifests/opencode/reports/1.18.4/**`
- `cli_manifests/opencode/versions/1.18.4.json`
...
- reopen pr branch: `automation/opencode-maintenance-1.18.4`
- notes:
...
```md
# Packet PR Maintenance Prompt (`1.18.4`)
...
Execute the automated maintenance packet for `opencode` target `1.18.4`.
...
1. Compare the current validated baseline from `cli_manifests/opencode/latest_validated.txt` against the target `1.18.4` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/opencode/snapshots/1.18.4/`, `cli_manifests/opencode/reports/1.18.4/`, and `cli_manifests/opencode/versions/1.18.4.json` as required by the packet.
