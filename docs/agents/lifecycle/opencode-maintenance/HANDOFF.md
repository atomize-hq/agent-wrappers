...
- target_version: `1.18.11`
- latest_stable: `1.18.12`
- version_policy: `latest_stable_minus_one`
- source_kind: `github_releases`
- source_ref: `anomalyco/opencode`
- dispatch_kind: `packet_pr`
- dispatch_workflow: `agent-maintenance-open-pr.yml`
- branch_name: `automation/opencode-maintenance-1.18.11`
...
- prompt sha256: `57284bc692f969f458747be8861335d798a15c4e14f28d787fa4500c59a2ec16`
...
- branch linkage: `automation/opencode-maintenance-1.18.11`
...
- `cli_manifests/opencode/snapshots/1.18.11/**`
- `cli_manifests/opencode/reports/1.18.11/**`
- `cli_manifests/opencode/versions/1.18.11.json`
...
- reopen pr branch: `automation/opencode-maintenance-1.18.11`
- notes:
...
```md
# Packet PR Maintenance Prompt (`1.18.11`)
...
Execute the automated maintenance packet for `opencode` target `1.18.11`.
...
1. Compare the current validated baseline from `cli_manifests/opencode/latest_validated.txt` against the target `1.18.11` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/opencode/snapshots/1.18.11/`, `cli_manifests/opencode/reports/1.18.11/`, and `cli_manifests/opencode/versions/1.18.11.json` as required by the packet.
