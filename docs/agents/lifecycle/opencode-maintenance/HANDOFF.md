...
- prompt sha256: `a66c0fdd5de2b53af2c4f29cdd3c3d740d4e7b6b9baee9d98b6351b52c712a1c`
...
- branch linkage: `automation/opencode-maintenance-1.18.26`
...
- `cli_manifests/opencode/snapshots/1.18.26/**`
- `cli_manifests/opencode/reports/1.18.26/**`
- `cli_manifests/opencode/versions/1.18.26.json`
...
- reopen pr branch: `automation/opencode-maintenance-1.18.26`
- notes:
...
```md
# Packet PR Maintenance Prompt (`1.18.26`)
...
Execute the automated maintenance packet for `opencode` target `1.18.26`.
...
1. Compare the current validated baseline from `cli_manifests/opencode/latest_validated.txt` against the target `1.18.26` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/opencode/snapshots/1.18.26/`, `cli_manifests/opencode/reports/1.18.26/`, and `cli_manifests/opencode/versions/1.18.26.json` as required by the packet.
