...
- prompt sha256: `6752c11b1859d845d83e2214845cb7e8d92a467e01973938ff5790aeb9bc9ede`
...
- branch linkage: `automation/opencode-maintenance-1.18.8`
...
- `cli_manifests/opencode/snapshots/1.18.8/**`
- `cli_manifests/opencode/reports/1.18.8/**`
- `cli_manifests/opencode/versions/1.18.8.json`
...
- reopen pr branch: `automation/opencode-maintenance-1.18.8`
- notes:
...
```md
# Packet PR Maintenance Prompt (`1.18.8`)
...
Execute the automated maintenance packet for `opencode` target `1.18.8`.
...
1. Compare the current validated baseline from `cli_manifests/opencode/latest_validated.txt` against the target `1.18.8` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/opencode/snapshots/1.18.8/`, `cli_manifests/opencode/reports/1.18.8/`, and `cli_manifests/opencode/versions/1.18.8.json` as required by the packet.
