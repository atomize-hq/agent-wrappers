...
- prompt sha256: `637a4e780905a863502901801e9f2b98da443ffeee98833dd71501ffb54f694d`
...
- branch linkage: `automation/opencode-maintenance-1.18.10`
...
- `cli_manifests/opencode/snapshots/1.18.10/**`
- `cli_manifests/opencode/reports/1.18.10/**`
- `cli_manifests/opencode/versions/1.18.10.json`
...
- reopen pr branch: `automation/opencode-maintenance-1.18.10`
- notes:
...
```md
# Packet PR Maintenance Prompt (`1.18.10`)
...
Execute the automated maintenance packet for `opencode` target `1.18.10`.
...
1. Compare the current validated baseline from `cli_manifests/opencode/latest_validated.txt` against the target `1.18.10` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/opencode/snapshots/1.18.10/`, `cli_manifests/opencode/reports/1.18.10/`, and `cli_manifests/opencode/versions/1.18.10.json` as required by the packet.
