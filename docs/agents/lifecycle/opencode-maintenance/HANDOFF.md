...
- target_version: `1.18.20`
- latest_stable: `1.18.21`
- version_policy: `latest_stable_minus_one`
- source_kind: `github_releases`
- source_ref: `anomalyco/opencode`
- dispatch_kind: `packet_pr`
- dispatch_workflow: `agent-maintenance-open-pr.yml`
- branch_name: `automation/opencode-maintenance-1.18.20`
...
- prompt sha256: `f0fd3bddcafb68defe165657575df8c7802fe0ba0e14d2412f8fce39a8736fce`
...
- branch linkage: `automation/opencode-maintenance-1.18.20`
...
- `cli_manifests/opencode/snapshots/1.18.20/**`
- `cli_manifests/opencode/reports/1.18.20/**`
- `cli_manifests/opencode/versions/1.18.20.json`
...
- reopen pr branch: `automation/opencode-maintenance-1.18.20`
- notes:
...
```md
# Packet PR Maintenance Prompt (`1.18.20`)
...
Execute the automated maintenance packet for `opencode` target `1.18.20`.
...
1. Compare the current validated baseline from `cli_manifests/opencode/latest_validated.txt` against the target `1.18.20` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/opencode/snapshots/1.18.20/`, `cli_manifests/opencode/reports/1.18.20/`, and `cli_manifests/opencode/versions/1.18.20.json` as required by the packet.
