...
- target_version: `1.18.12`
- latest_stable: `1.18.13`
- version_policy: `latest_stable_minus_one`
- source_kind: `github_releases`
- source_ref: `anomalyco/opencode`
- dispatch_kind: `packet_pr`
- dispatch_workflow: `agent-maintenance-open-pr.yml`
- branch_name: `automation/opencode-maintenance-1.18.12`
...
- prompt sha256: `a4745dc3051a44378961a8db4d044b7545cdc635eb972125c741505d74389c47`
...
- branch linkage: `automation/opencode-maintenance-1.18.12`
...
- `cli_manifests/opencode/snapshots/1.18.12/**`
- `cli_manifests/opencode/reports/1.18.12/**`
- `cli_manifests/opencode/versions/1.18.12.json`
...
- reopen pr branch: `automation/opencode-maintenance-1.18.12`
- notes:
...
```md
# Packet PR Maintenance Prompt (`1.18.12`)
...
Execute the automated maintenance packet for `opencode` target `1.18.12`.
...
1. Compare the current validated baseline from `cli_manifests/opencode/latest_validated.txt` against the target `1.18.12` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/opencode/snapshots/1.18.12/`, `cli_manifests/opencode/reports/1.18.12/`, and `cli_manifests/opencode/versions/1.18.12.json` as required by the packet.
