...
- prompt sha256: `dbf0c4f8a780c1f987f35c5d90eafd3acca2cbf1f7184b792965194197240cae`
...
- branch linkage: `automation/opencode-maintenance-1.18.5`
...
- `cli_manifests/opencode/snapshots/1.18.5/**`
- `cli_manifests/opencode/reports/1.18.5/**`
- `cli_manifests/opencode/versions/1.18.5.json`
...
- reopen pr branch: `automation/opencode-maintenance-1.18.5`
- notes:
...
```md
# Packet PR Maintenance Prompt (`1.18.5`)
...
Execute the automated maintenance packet for `opencode` target `1.18.5`.
...
1. Compare the current validated baseline from `cli_manifests/opencode/latest_validated.txt` against the target `1.18.5` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/opencode/snapshots/1.18.5/`, `cli_manifests/opencode/reports/1.18.5/`, and `cli_manifests/opencode/versions/1.18.5.json` as required by the packet.
