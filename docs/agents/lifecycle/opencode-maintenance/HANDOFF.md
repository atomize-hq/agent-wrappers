...
- target_version: `1.18.21`
- latest_stable: `1.18.22`
- version_policy: `latest_stable_minus_one`
- source_kind: `github_releases`
- source_ref: `anomalyco/opencode`
- dispatch_kind: `packet_pr`
- dispatch_workflow: `agent-maintenance-open-pr.yml`
- branch_name: `automation/opencode-maintenance-1.18.21`
...
- prompt sha256: `74bd8d4d5a2da5622e53bc4376f0d794c7dc80eee977688d84d9cc481c26dc05`
...
- branch linkage: `automation/opencode-maintenance-1.18.21`
...
- `cli_manifests/opencode/snapshots/1.18.21/**`
- `cli_manifests/opencode/reports/1.18.21/**`
- `cli_manifests/opencode/versions/1.18.21.json`
...
- reopen pr branch: `automation/opencode-maintenance-1.18.21`
- notes:
...
```md
# Packet PR Maintenance Prompt (`1.18.21`)
...
Execute the automated maintenance packet for `opencode` target `1.18.21`.
...
1. Compare the current validated baseline from `cli_manifests/opencode/latest_validated.txt` against the target `1.18.21` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/opencode/snapshots/1.18.21/`, `cli_manifests/opencode/reports/1.18.21/`, and `cli_manifests/opencode/versions/1.18.21.json` as required by the packet.
