...
- target_version: `1.18.14`
- latest_stable: `1.18.15`
- version_policy: `latest_stable_minus_one`
- source_kind: `github_releases`
- source_ref: `anomalyco/opencode`
- dispatch_kind: `packet_pr`
- dispatch_workflow: `agent-maintenance-open-pr.yml`
- branch_name: `automation/opencode-maintenance-1.18.14`
...
- prompt sha256: `d0f7ec7dabd8802e55256379c8c29f592393b4364f5c8b6c2910031685ef47e0`
...
- branch linkage: `automation/opencode-maintenance-1.18.14`
...
- `cli_manifests/opencode/snapshots/1.18.14/**`
- `cli_manifests/opencode/reports/1.18.14/**`
- `cli_manifests/opencode/versions/1.18.14.json`
...
- reopen pr branch: `automation/opencode-maintenance-1.18.14`
- notes:
...
```md
# Packet PR Maintenance Prompt (`1.18.14`)
...
Execute the automated maintenance packet for `opencode` target `1.18.14`.
...
1. Compare the current validated baseline from `cli_manifests/opencode/latest_validated.txt` against the target `1.18.14` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/opencode/snapshots/1.18.14/`, `cli_manifests/opencode/reports/1.18.14/`, and `cli_manifests/opencode/versions/1.18.14.json` as required by the packet.
