...
- prompt sha256: `5a19b5bc50001b7344a928a9f4ad8512807c5c0f59058e07c04fa99bb0f438eb`
...
- branch linkage: `automation/opencode-maintenance-1.18.25`
...
- `cli_manifests/opencode/snapshots/1.18.25/**`
- `cli_manifests/opencode/reports/1.18.25/**`
- `cli_manifests/opencode/versions/1.18.25.json`
...
- reopen pr branch: `automation/opencode-maintenance-1.18.25`
- notes:
...
```md
# Packet PR Maintenance Prompt (`1.18.25`)
...
Execute the automated maintenance packet for `opencode` target `1.18.25`.
...
1. Compare the current validated baseline from `cli_manifests/opencode/latest_validated.txt` against the target `1.18.25` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/opencode/snapshots/1.18.25/`, `cli_manifests/opencode/reports/1.18.25/`, and `cli_manifests/opencode/versions/1.18.25.json` as required by the packet.
