...
- prompt sha256: `a6d3773cd66b255d90aec5f810cb507a55a058719fac7b6f759d062ba670f8b2`
...
- branch linkage: `automation/opencode-maintenance-1.18.3`
...
- `cli_manifests/opencode/snapshots/1.18.3/**`
- `cli_manifests/opencode/reports/1.18.3/**`
- `cli_manifests/opencode/versions/1.18.3.json`
...
- reopen pr branch: `automation/opencode-maintenance-1.18.3`
- notes:
...
```md
# Packet PR Maintenance Prompt (`1.18.3`)
...
Execute the automated maintenance packet for `opencode` target `1.18.3`.
...
1. Compare the current validated baseline from `cli_manifests/opencode/latest_validated.txt` against the target `1.18.3` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/opencode/snapshots/1.18.3/`, `cli_manifests/opencode/reports/1.18.3/`, and `cli_manifests/opencode/versions/1.18.3.json` as required by the packet.
