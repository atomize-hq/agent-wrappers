...
- target_version: `1.18.13`
- latest_stable: `1.18.14`
- version_policy: `latest_stable_minus_one`
- source_kind: `github_releases`
- source_ref: `anomalyco/opencode`
- dispatch_kind: `packet_pr`
- dispatch_workflow: `agent-maintenance-open-pr.yml`
- branch_name: `automation/opencode-maintenance-1.18.13`
...
- prompt sha256: `e61601e5f7664f6eff92d423d439518ef76f470c008c88f44b1aa887342d64f0`
...
- branch linkage: `automation/opencode-maintenance-1.18.13`
...
- `cli_manifests/opencode/snapshots/1.18.13/**`
- `cli_manifests/opencode/reports/1.18.13/**`
- `cli_manifests/opencode/versions/1.18.13.json`
...
- reopen pr branch: `automation/opencode-maintenance-1.18.13`
- notes:
...
```md
# Packet PR Maintenance Prompt (`1.18.13`)
...
Execute the automated maintenance packet for `opencode` target `1.18.13`.
...
1. Compare the current validated baseline from `cli_manifests/opencode/latest_validated.txt` against the target `1.18.13` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/opencode/snapshots/1.18.13/`, `cli_manifests/opencode/reports/1.18.13/`, and `cli_manifests/opencode/versions/1.18.13.json` as required by the packet.
