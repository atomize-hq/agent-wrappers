...
- prompt sha256: `7205e584c71130f4eb2464bbf5aa4762bddc2be921760ba4bf1e3a897ca158a6`
...
- branch linkage: `automation/opencode-maintenance-1.18.6`
...
- `cli_manifests/opencode/snapshots/1.18.6/**`
- `cli_manifests/opencode/reports/1.18.6/**`
- `cli_manifests/opencode/versions/1.18.6.json`
...
- reopen pr branch: `automation/opencode-maintenance-1.18.6`
- notes:
...
```md
# Packet PR Maintenance Prompt (`1.18.6`)
...
Execute the automated maintenance packet for `opencode` target `1.18.6`.
...
1. Compare the current validated baseline from `cli_manifests/opencode/latest_validated.txt` against the target `1.18.6` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/opencode/snapshots/1.18.6/`, `cli_manifests/opencode/reports/1.18.6/`, and `cli_manifests/opencode/versions/1.18.6.json` as required by the packet.
