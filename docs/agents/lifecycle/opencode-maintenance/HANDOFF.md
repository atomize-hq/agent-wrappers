...
- prompt sha256: `1de4091b21f9708116e8cc1dbb8e42fbb92d236f4714e7dd330452ad737b82fd`
...
- branch linkage: `automation/opencode-maintenance-1.18.15`
...
- `cli_manifests/opencode/snapshots/1.18.15/**`
- `cli_manifests/opencode/reports/1.18.15/**`
- `cli_manifests/opencode/versions/1.18.15.json`
...
- reopen pr branch: `automation/opencode-maintenance-1.18.15`
- notes:
...
```md
# Packet PR Maintenance Prompt (`1.18.15`)
...
Execute the automated maintenance packet for `opencode` target `1.18.15`.
...
1. Compare the current validated baseline from `cli_manifests/opencode/latest_validated.txt` against the target `1.18.15` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/opencode/snapshots/1.18.15/`, `cli_manifests/opencode/reports/1.18.15/`, and `cli_manifests/opencode/versions/1.18.15.json` as required by the packet.
