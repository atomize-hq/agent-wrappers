...
- prompt sha256: `d9eb681fd7acbc6cc5209c0a381adb33b77bed4b75bed96733efef56fe9dd8ed`
...
- branch linkage: `automation/codex-maintenance-0.152.0`
...
- `cli_manifests/codex/snapshots/0.152.0/**`
- `cli_manifests/codex/reports/0.152.0/**`
- `cli_manifests/codex/versions/0.152.0.json`
...
- reopen pr branch: `automation/codex-maintenance-0.152.0`
- notes:
...
```md
# Packet PR Maintenance Prompt (`0.152.0`)
...
Execute the automated maintenance packet for `codex` target `0.152.0`.
...
1. Compare the current validated baseline from `cli_manifests/codex/latest_validated.txt` against the target `0.152.0` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/codex/snapshots/0.152.0/`, `cli_manifests/codex/reports/0.152.0/`, and `cli_manifests/codex/versions/0.152.0.json` as required by the packet.
