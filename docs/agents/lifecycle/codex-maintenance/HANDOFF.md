...
- prompt sha256: `ee9c908942f38bb1a394a1658fb3cf821108b7d2bf6b4b85faefaeafe22fb0e8`
...
- branch linkage: `automation/codex-maintenance-0.150.1`
...
- `cli_manifests/codex/snapshots/0.150.1/**`
- `cli_manifests/codex/reports/0.150.1/**`
- `cli_manifests/codex/versions/0.150.1.json`
...
- reopen pr branch: `automation/codex-maintenance-0.150.1`
- notes:
...
```md
# Packet PR Maintenance Prompt (`0.150.1`)
...
Execute the automated maintenance packet for `codex` target `0.150.1`.
...
1. Compare the current validated baseline from `cli_manifests/codex/latest_validated.txt` against the target `0.150.1` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/codex/snapshots/0.150.1/`, `cli_manifests/codex/reports/0.150.1/`, and `cli_manifests/codex/versions/0.150.1.json` as required by the packet.
