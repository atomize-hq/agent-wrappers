...
- prompt sha256: `c6d359913291e521430869af1a8122d306422a841d06cfbd65bc115e2a13b183`
...
- branch linkage: `automation/codex-maintenance-0.147.0`
...
- `cli_manifests/codex/snapshots/0.147.0/**`
- `cli_manifests/codex/reports/0.147.0/**`
- `cli_manifests/codex/versions/0.147.0.json`
...
- reopen pr branch: `automation/codex-maintenance-0.147.0`
- notes:
...
```md
# Packet PR Maintenance Prompt (`0.147.0`)
...
Execute the automated maintenance packet for `codex` target `0.147.0`.
...
1. Compare the current validated baseline from `cli_manifests/codex/latest_validated.txt` against the target `0.147.0` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/codex/snapshots/0.147.0/`, `cli_manifests/codex/reports/0.147.0/`, and `cli_manifests/codex/versions/0.147.0.json` as required by the packet.
