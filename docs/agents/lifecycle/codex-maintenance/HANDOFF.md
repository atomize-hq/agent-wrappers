...
- prompt sha256: `515553eca5b54eb1546d02cc4838f53015a0785db9b34f3a579d4370dd912062`
...
- branch linkage: `automation/codex-maintenance-0.148.0`
...
- `cli_manifests/codex/snapshots/0.148.0/**`
- `cli_manifests/codex/reports/0.148.0/**`
- `cli_manifests/codex/versions/0.148.0.json`
...
- reopen pr branch: `automation/codex-maintenance-0.148.0`
- notes:
...
```md
# Packet PR Maintenance Prompt (`0.148.0`)
...
Execute the automated maintenance packet for `codex` target `0.148.0`.
...
1. Compare the current validated baseline from `cli_manifests/codex/latest_validated.txt` against the target `0.148.0` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/codex/snapshots/0.148.0/`, `cli_manifests/codex/reports/0.148.0/`, and `cli_manifests/codex/versions/0.148.0.json` as required by the packet.
