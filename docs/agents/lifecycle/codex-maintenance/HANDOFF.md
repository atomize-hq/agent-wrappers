...
- prompt sha256: `f9aa1158475be2293672a11c3bbe48ed74156a859944bacd2fe2a5dbda3d692d`
...
- branch linkage: `automation/codex-maintenance-0.151.0`
...
- `cli_manifests/codex/snapshots/0.151.0/**`
- `cli_manifests/codex/reports/0.151.0/**`
- `cli_manifests/codex/versions/0.151.0.json`
...
- reopen pr branch: `automation/codex-maintenance-0.151.0`
- notes:
...
```md
# Packet PR Maintenance Prompt (`0.151.0`)
...
Execute the automated maintenance packet for `codex` target `0.151.0`.
...
1. Compare the current validated baseline from `cli_manifests/codex/latest_validated.txt` against the target `0.151.0` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/codex/snapshots/0.151.0/`, `cli_manifests/codex/reports/0.151.0/`, and `cli_manifests/codex/versions/0.151.0.json` as required by the packet.
