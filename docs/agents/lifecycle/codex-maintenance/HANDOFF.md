...
- prompt sha256: `63618558e6a2c8250cfab5a5b9dcfe7068d31ee27464e3595d1718248285d0ce`
...
- branch linkage: `automation/codex-maintenance-0.149.0`
...
- `cli_manifests/codex/snapshots/0.149.0/**`
- `cli_manifests/codex/reports/0.149.0/**`
- `cli_manifests/codex/versions/0.149.0.json`
...
- reopen pr branch: `automation/codex-maintenance-0.149.0`
- notes:
...
```md
# Packet PR Maintenance Prompt (`0.149.0`)
...
Execute the automated maintenance packet for `codex` target `0.149.0`.
...
1. Compare the current validated baseline from `cli_manifests/codex/latest_validated.txt` against the target `0.149.0` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/codex/snapshots/0.149.0/`, `cli_manifests/codex/reports/0.149.0/`, and `cli_manifests/codex/versions/0.149.0.json` as required by the packet.
