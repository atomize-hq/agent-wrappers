...
- prompt sha256: `76d324660d990f48f1575bae02f11357b44a06d5889060264cfb0eab0f1acdce`
...
- branch linkage: `automation/codex-maintenance-0.150.0`
...
- `cli_manifests/codex/snapshots/0.150.0/**`
- `cli_manifests/codex/reports/0.150.0/**`
- `cli_manifests/codex/versions/0.150.0.json`
...
- reopen pr branch: `automation/codex-maintenance-0.150.0`
- notes:
...
```md
# Packet PR Maintenance Prompt (`0.150.0`)
...
Execute the automated maintenance packet for `codex` target `0.150.0`.
...
1. Compare the current validated baseline from `cli_manifests/codex/latest_validated.txt` against the target `0.150.0` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/codex/snapshots/0.150.0/`, `cli_manifests/codex/reports/0.150.0/`, and `cli_manifests/codex/versions/0.150.0.json` as required by the packet.
