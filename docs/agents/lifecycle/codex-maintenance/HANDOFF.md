...
- prompt sha256: `660b9f374c4e5d4b9269522024d649a8287de2d3c66f5d7084fc6b8d52f30e41`
...
- branch linkage: `automation/codex-maintenance-0.152.1`
...
- `cli_manifests/codex/snapshots/0.152.1/**`
- `cli_manifests/codex/reports/0.152.1/**`
- `cli_manifests/codex/versions/0.152.1.json`
...
- reopen pr branch: `automation/codex-maintenance-0.152.1`
- notes:
...
```md
# Packet PR Maintenance Prompt (`0.152.1`)
...
Execute the automated maintenance packet for `codex` target `0.152.1`.
...
1. Compare the current validated baseline from `cli_manifests/codex/latest_validated.txt` against the target `0.152.1` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/codex/snapshots/0.152.1/`, `cli_manifests/codex/reports/0.152.1/`, and `cli_manifests/codex/versions/0.152.1.json` as required by the packet.
