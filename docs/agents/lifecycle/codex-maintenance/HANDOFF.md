...
- prompt sha256: `a982d27500df988c1787ed6119ef8dc934f7a5131ead69fa0cf39eeecd476f3b`
...
- branch linkage: `automation/codex-maintenance-0.145.0`
...
- `cli_manifests/codex/snapshots/0.145.0/**`
- `cli_manifests/codex/reports/0.145.0/**`
- `cli_manifests/codex/versions/0.145.0.json`
...
- reopen pr branch: `automation/codex-maintenance-0.145.0`
- notes:
...
```md
# Packet PR Maintenance Prompt (`0.145.0`)
...
Execute the automated maintenance packet for `codex` target `0.145.0`.
...
1. Compare the current validated baseline from `cli_manifests/codex/latest_validated.txt` against the target `0.145.0` artifacts.
...
4. Refresh or create version-scoped manifest artifacts under `cli_manifests/codex/snapshots/0.145.0/`, `cli_manifests/codex/reports/0.145.0/`, and `cli_manifests/codex/versions/0.145.0.json` as required by the packet.
