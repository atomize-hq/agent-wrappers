...
| agent | version | target | manifest_support | backend_support | uaa_support | pointer_promotion | evidence_notes |
|---|---|---|---|---|---|---|---|
| `opencode` | `1.18.9` | `darwin-arm64` | `unsupported` | `unsupported` | `unsupported` | `none` | — |
...
| `opencode` | `1.18.9` | `darwin-x64` | `unsupported` | `unsupported` | `unsupported` | `none` | — |
...
| `opencode` | `1.18.9` | `linux-arm64` | `unsupported` | `unsupported` | `unsupported` | `none` | — |
...
| `opencode` | `1.18.9` | `linux-x64` | `unsupported` | `unsupported` | `unsupported` | `none` | — |
...
| `opencode` | `1.18.9` | `win32-arm64` | `unsupported` | `unsupported` | `unsupported` | `none` | — |
...
| `opencode` | `1.18.9` | `win32-x64` | `unsupported` | `unsupported` | `unsupported` | `none` | — |
