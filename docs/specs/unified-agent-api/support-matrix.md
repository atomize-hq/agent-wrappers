...
| agent | version | target | manifest_support | backend_support | uaa_support | pointer_promotion | evidence_notes |
|---|---|---|---|---|---|---|---|
| `opencode` | `1.18.10` | `darwin-arm64` | `unsupported` | `unsupported` | `unsupported` | `none` | — |
...
| `opencode` | `1.18.10` | `darwin-x64` | `unsupported` | `unsupported` | `unsupported` | `none` | — |
...
| `opencode` | `1.18.10` | `linux-arm64` | `unsupported` | `unsupported` | `unsupported` | `none` | — |
...
| `opencode` | `1.18.10` | `linux-x64` | `unsupported` | `unsupported` | `unsupported` | `none` | — |
...
| `opencode` | `1.18.10` | `win32-arm64` | `unsupported` | `unsupported` | `unsupported` | `none` | — |
...
| `opencode` | `1.18.10` | `win32-x64` | `unsupported` | `unsupported` | `unsupported` | `none` | — |
