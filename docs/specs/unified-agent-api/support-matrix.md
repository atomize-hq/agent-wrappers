...
| agent | version | target | manifest_support | backend_support | uaa_support | pointer_promotion | evidence_notes |
|---|---|---|---|---|---|---|---|
| `opencode` | `1.18.13` | `darwin-arm64` | `unsupported` | `unsupported` | `unsupported` | `none` | — |
...
| `opencode` | `1.18.13` | `darwin-x64` | `unsupported` | `unsupported` | `unsupported` | `none` | — |
...
| `opencode` | `1.18.13` | `linux-arm64` | `unsupported` | `unsupported` | `unsupported` | `none` | — |
...
| `opencode` | `1.18.13` | `linux-x64` | `unsupported` | `unsupported` | `unsupported` | `none` | — |
...
| `opencode` | `1.18.13` | `win32-arm64` | `unsupported` | `unsupported` | `unsupported` | `none` | — |
...
| `opencode` | `1.18.13` | `win32-x64` | `unsupported` | `unsupported` | `unsupported` | `none` | — |
