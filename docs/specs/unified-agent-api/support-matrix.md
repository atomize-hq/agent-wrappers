...
| agent | version | target | manifest_support | backend_support | uaa_support | pointer_promotion | evidence_notes |
|---|---|---|---|---|---|---|---|
| `opencode` | `1.18.11` | `darwin-arm64` | `unsupported` | `unsupported` | `unsupported` | `none` | — |
...
| `opencode` | `1.18.11` | `darwin-x64` | `unsupported` | `unsupported` | `unsupported` | `none` | — |
...
| `opencode` | `1.18.11` | `linux-arm64` | `unsupported` | `unsupported` | `unsupported` | `none` | — |
...
| `opencode` | `1.18.11` | `linux-x64` | `unsupported` | `unsupported` | `unsupported` | `none` | — |
...
| `opencode` | `1.18.11` | `win32-arm64` | `unsupported` | `unsupported` | `unsupported` | `none` | — |
...
| `opencode` | `1.18.11` | `win32-x64` | `unsupported` | `unsupported` | `unsupported` | `none` | — |
